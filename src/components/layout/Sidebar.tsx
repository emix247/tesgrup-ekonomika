  ...
  const sidebarContent = (
    <>
      ...
      <div className="px-3 pb-4 space-y-2">
        ...
        <button
          onClick={() => {
            document.cookie = 'tesgrup-auth=; path=/; max-age=0';
            window.location.href = '/login';
          }}
          className="flex items-center justify-center gap-2 w-full px-4 py-2.5 text-gray-400 hover:text-white hover:bg-sidebar-hover text-sm font-medium rounded-lg transition-colors"
        >
