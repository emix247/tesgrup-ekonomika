    ...
    <div>
      <div className="mb-4 sm:mb-6 flex items-start justify-between gap-3">
        ...
        <Link
          ...
          className="shrink-0 inline-flex items-center gap-1.5 px-2.5 py-1.5 text-xs sm:text-sm text-gray-600 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
        >
